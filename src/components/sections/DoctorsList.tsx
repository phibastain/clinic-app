                    ...
                    {DOCTORS.filter(doc => doc.slug !== 'dr.none').map(doc => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <p className="text-[8px] md:text-[9px] font-black text-amber-600 uppercase tracking-widest mb-1 text-center">{(isAR && doc.expertAR) || (isTH && doc.expertTH) || doc.expert}</p>
                                <h3 className="text-base md:text-lg font-black text-slate-900 dark:text-white uppercase leading-tight text-center">{(isAR && doc.nameAR) || (isTH && doc.nameTH) || doc.name}</h3>
                                <p className="text-slate-500 text-[10px] md:text-xs italic text-center">{(isAR && doc.roleAR) || (isTH && doc.roleTH) || doc.role}</p>
                            </Link>
                        );
                    })}
                </div>
