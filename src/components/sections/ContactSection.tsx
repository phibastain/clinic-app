...
import { MapPin, Phone, MessageCircle, Calendar, ChevronDown, ShieldCheck, Send, CheckCircle2, AlertCircle, Loader2 } from 'lucide-react';
                        ...
                        <div className="bg-linear-to-br from-white/90 via-slate-50/50 to-indigo-50/40 dark:from-[#1a1a1a]/90 dark:to-[#202030]/80 backdrop-blur-xl rounded-[2.5rem] p-8 md:p-10 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] dark:shadow-[0_0_30px_rgba(0,0,0,0.3)] border border-slate-100 dark:border-white/10 h-full relative overflow-hidden">
                            ...
                            {formStatus === 'success' && (
                                <div className="mb-6 p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-700/30 rounded-2xl flex items-start gap-3 animate-in fade-in slide-in-from-top-2 duration-300">
                                    ...
                                    <div>
                                        <p className="font-bold text-green-800 dark:text-green-300 text-sm">Appointment Request Sent Successfully!</p>
                                        <p className="text-green-600 dark:text-green-400 text-xs mt-1">We will contact you within 24 hours to confirm your appointment. Thank you!</p>
                                    </div>
                                </div>
                            )}
                            ...
                            {formStatus === 'error' && (
                                <div className="mb-6 p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-700/30 rounded-2xl flex items-start gap-3 animate-in fade-in slide-in-from-top-2 duration-300">
                                    ...
                                    <div>
                                        <p className="font-bold text-red-800 dark:text-red-300 text-sm">Submission Failed</p>
                            ...
                            {validationError && (
                                <div className="mb-6 p-4 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700/30 rounded-2xl flex items-start gap-3 animate-in fade-in slide-in-from-top-2 duration-300">
                                    ...
                                    <div>
                                        <p className="font-bold text-amber-800 dark:text-amber-300 text-sm">Incomplete Information</p>
                            ...
                            <form onSubmit={onSubmit} className="space-y-5">
                                ...
                                <div className="grid md:grid-cols-2 gap-5">
                                    <div className="space-y-1.5">
                                        <label htmlFor="booking-name" className="text-[10px] font-bold text-slate-500 uppercase tracking-wider ml-2">Full Name *</label>
                                        <input id="booking-name" name="Full Name" type="text" placeholder="Your Name" autoComplete="name" required className="w-full bg-slate-50/50 dark:bg-slate-950/50 border border-slate-200 dark:border-slate-700 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-amber-500 transition-colors placeholder:text-slate-400 dark:text-white" />
                                    </div>
                                    <div className="space-y-1.5">
                                        <label htmlFor="booking-phone" className="text-[10px] font-bold text-slate-500 uppercase tracking-wider ml-2">Phone Number *</label>
                                ...
                                <div className="grid md:grid-cols-2 gap-5">
                                    <div className="space-y-1.5">
                                        <label htmlFor="booking-email" className="text-[10px] font-bold text-slate-500 uppercase tracking-wider ml-2">Email *</label>
                                    ...
                                    <div className="space-y-1.5">
                                        <label htmlFor="booking-service" className="text-[10px] font-bold text-slate-500 uppercase tracking-wider ml-2">Service of Interest</label>
                                ...
                                <div className="grid md:grid-cols-2 gap-5">
                                    <div className="space-y-1.5">
                                        <label htmlFor="booking-date" className="text-[10px] font-bold text-slate-500 uppercase tracking-wider ml-2">Preferred Date</label>
                                    ...
                                    <div className="space-y-1.5">
                                        <label htmlFor="booking-time" className="text-[10px] font-bold text-slate-500 uppercase tracking-wider ml-2">Preferred Time</label>
                                ...
                                <div className="pt-4 flex items-center justify-between">
                                    ...
                                    >
                                        ...
                                        <span className="relative z-10">{formStatus === 'sending' ? 'Sending...' : 'Confirm Booking'}</span>
                                        {formStatus === 'sending'
