            ...
            <Container>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    >
                        ...
                        <div className="absolute inset-0 bg-linear-to-t from-slate-900 via-slate-900/60 to-transparent p-6 md:p-10 flex flex-col justify-end">
                            <span className="inline-block px-3 py-1 bg-amber-600 text-white text-[7px] md:text-[9px] font-black uppercase tracking-widest rounded-lg mb-3 w-fit">{t(featured.category)}</span>
                            <h3 className="text-xl md:text-3xl font-black text-white uppercase leading-tight mb-2">
                            ...
                            <span className="flex items-center text-[10px] md:text-xs font-black text-white uppercase group/btn w-fit hover:text-amber-500 transition-colors">
                    ...
                    <div className="flex flex-col gap-5">
                        {others.map((event) => {
                            ...
                            >
                                <div className="relative w-full sm:w-32 md:w-40 aspect-4/3 sm:aspect-square rounded-2xl overflow-hidden shrink-0">
                                ...
                                <div className="flex flex-col justify-center flex-1 pr-2">
                                    <div className="flex items-center gap-2 mb-2">
                                        <span className="text-[6px] md:text-[8px] font-black text-amber-600 uppercase tracking-widest border border-amber-600/20 px-2 py-0.5 rounded-md">{t(event.category)}</span>
                                    </div>
                                    <h4 className="text-sm md:text-lg font-black text-slate-900 dark:text-white uppercase leading-none mb-1 group-hover:text-amber-600 transition-colors">
                                        {getLocalizedField(event, 'title', lang, t)}
                                    </h4>
                                    <p className="text-[10px] md:text-xs text-slate-500 font-bold uppercase tracking-wide mb-4">
                                        {getLocalizedField(event, 'subtitle', lang, t)}
                                    </p>
                                    <span className="flex items-center text-[10px] md:text-xs font-black text-slate-900 dark:text-white uppercase group/btn w-fit hover:text-amber-600 transition-colors">
                                        <span className="mr-2">{t('View Details')}</span>
